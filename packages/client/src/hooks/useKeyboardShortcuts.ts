...
export function createWhiteboardShortcuts<TTool extends string>(
  ...
  return [
    ...
    {
      key: "v",
      action: () => actions.setTool("select" as TTool),
      description: "Select tool",
    },
    {
      key: "p",
      action: () => actions.setTool("pen" as TTool),
      description: "Pen tool",
    },
    {
      key: "l",
      action: () => actions.setTool("line" as TTool),
      description: "Line tool",
    },
    {
      key: "r",
      action: () => actions.setTool("rectangle" as TTool),
      description: "Rectangle tool",
    },
    {
      key: "o",
      action: () => actions.setTool("circle" as TTool),
    ...
    {
      key: "h",
      action: () => actions.setTool("hand" as TTool),
