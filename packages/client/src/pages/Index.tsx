...
const App: React.FC = () => {
  ...
  const customStyles: Record<string, string> = {
    ...
    '--gradient-primary': 'linear-gradient(135deg, hsl(245 58% 61%), hsl(263 85% 75%))',
    '--gradient-surface': 'linear-gradient(180deg, hsl(210 11% 11%), hsl(210 11% 9%))',
    '--accent': '0 0% 14.9%',
  ...
  return (
    <div className="relative font-sans bg-[hsl(var(--background))] text-[hsl(var(--foreground))] min-h-screen" style={customStyles}>
      ...
      <nav className="sticky top-0 z-40 bg-[hsl(var(--card))] bg-opacity-80 backdrop-blur-lg border-b border-[hsl(var(--border))] shadow-sm">
        <div className="container mx-auto px-4 py-4 md:py-6 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold text-[hsl(var(--foreground))] hidden sm:block">Whiteboard</span>
          </div>

          <div className="hidden md:flex items-center space-x-6">
            <a href="#" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary-hover))] transition-colors">Features</a>
            <a href="#" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary-hover))] transition-colors">Pricing</a>
            <a href="#" className="text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary-hover))] transition-colors">About</a>
          </div>

          {/* Mobile menu button */}
          <div className="md:hidden">
            <button onClick={handleMenuToggle} className="text-[hsl(var(--muted-foreground))]">
        ...
        >
          <div className="flex flex-col items-center py-4 border-t border-[hsl(var(--border-subtle))]">
            <a href="#" className="py-2 px-4 text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary-hover))] transition-colors">Features</a>
            <a href="#" className="py-2 px-4 text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary-hover))] transition-colors">Pricing</a>
            <a href="#" className="py-2 px-4 text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--primary-hover))] transition-colors">About</a>
          </div>
        </div>
      </nav>
      ...
      <main>
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-[hsl(var(--foreground))] leading-tight">
            Collaborate on <span className="text-[hsl(var(--primary-hover))]">Ideas,</span>
            <br />
            in Real Time.
          </h1>
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[hsl(var(--foreground))]">Designed for Seamless Collaboration</h2>
            <p className="mt-4 text-[hsl(var(--muted-foreground))] max-w-2xl mx-auto">Our features are built to enhance your workflow and bring your team closer together, no matter where they are.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-[hsl(var(--surface))] p-8 rounded-2xl shadow-xl flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold text-[hsl(var(--foreground))] mb-2">Infinite Canvas</h3>
              <p className="text-[hsl(var(--muted-foreground))]">Never run out of space. Our canvas expands as you do, allowing for limitless brainstorming and planning.</p>
            </div>
            <div className="bg-[hsl(var(--surface))] p-8 rounded-2xl shadow-xl flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-[hsl(var(--success)/0.1)] text-[hsl(var(--success))] flex items-center justify-center mb-4">
                <Users size={32} />
              </div>
              <h3 className="text-xl font-semibold text-[hsl(var(--foreground))] mb-2">Real-Time Sync</h3>
              <p className="text-[hsl(var(--muted-foreground))]">See changes from your team members instantly, as if you were in the same room.</p>
            </div>
            <div className="bg-[hsl(var(--surface))] p-8 rounded-2xl shadow-xl flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-[hsl(var(--warning)/0.1)] text-[hsl(var(--warning))] flex items-center justify-center mb-4">
                <Zap size={32} />
              </div>
              <h3 className="text-xl font-semibold text-[hsl(var(--foreground))] mb-2">High Performance</h3>
              <p className="text-[hsl(var(--muted-foreground))]">Our powerful engine ensures a smooth and lag-free experience, even with complex boards and many users.</p>
            </div>
          </div>
        </div>
      </main>
